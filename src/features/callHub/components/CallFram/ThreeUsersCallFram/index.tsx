...
import CallView from '../TwoUsersCallFram/DesktopCallView/CallView';
...
function ThreeUsersCallFram({ videoStreamsList }: CallFramProps) {
  return (
...
export default ThreeUsersCallFram;